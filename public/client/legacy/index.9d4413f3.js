import { _ as _inherits, a as _getPrototypeOf, b as _possibleConstructorReturn, c as _classCallCheck, i as init, s as safe_not_equal, d as _assertThisInitialized, e as dispatch_dev, S as SvelteComponentDev, v as validate_slots, f as element, g as space, t as text, h as claim_element, j as children, k as detach_dev, l as claim_space, m as claim_text, n as attr_dev, o as add_location, p as set_style, q as insert_dev, r as append_dev, u as noop, w as svg_element, x as create_component, y as query_selector_all, z as claim_component, A as mount_component, B as transition_in, C as transition_out, D as destroy_component } from './client.3406b4ed.js';
...
function create_fragment(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      div12 = element("div");
      div1 = element("div");
      t1 = text("Now available");
      t2 = space();
      h10 = element("h1");
      span0 = element("span");
      t3 = text("Make your ideas look awesome,");
      t4 = space();
      span1 = element("span");
      t5 = text("without relying on a designer.");
      t6 = space();
      div11 = element("div");
      div9 = element("div");
      div3 = element("div");
      div2 = element("div");
      t7 = text("Now available");
      t8 = space();
      h11 = element("h1");
      span2 = element("span");
      t9 = text("Make your ideas look awesome,");
      t10 = space();
      span3 = element("span");
      t11 = text("without relying on a designer.");
      t12 = space();
      p0 = element("p");
      t13 = text("Learn how to design beautiful user interfaces by yourself using\n              specific tactics explained from a developer's point-of-view.");
      t14 = space();
      div4 = element("div");
      img0 = element("img");
      t15 = space();
      ...
      t17 = space();
      span5 = element("span");
      t18 = text("Sign up for our newsletter to get\n              ");
      span4 = element("span");
      t19 = text("two free chapter previews");
      ...
      t23 = text("Get the previews");
      t24 = space();
      div7 = element("div");
      p1 = element("p");
      t25 = text("Something went wrong, please try again.");
      t26 = space();
      div8 = element("div");
      p2 = element("p");
      t27 = text("Or\n              ");
    ...
    l: function claim(nodes) {
      ...
      div1 = claim_element(div12_nodes, "DIV", {
        class: true
      });
      var div1_nodes = children(div1);
      t1 = claim_text(div1_nodes, "Now available");
      div1_nodes.forEach(detach_dev);
      t2 = claim_space(div12_nodes);
      h10 = claim_element(div12_nodes, "H1", {
        class: true
      });
      ...
      t3 = claim_text(span0_nodes, "Make your ideas look awesome,");
      ...
      t5 = claim_text(span1_nodes, "without relying on a designer.");
      ...
      t7 = claim_text(div2_nodes, "Now available");
      ...
      t9 = claim_text(span2_nodes, "Make your ideas look awesome,");
      ...
      t11 = claim_text(span3_nodes, "without relying on a designer.");
      ...
      t13 = claim_text(p0_nodes, "Learn how to design beautiful user interfaces by yourself using\n              specific tactics explained from a developer's point-of-view.");
      ...
      span5 = claim_element(form_nodes, "SPAN", {
        class: true
      });
      var span5_nodes = children(span5);
      t18 = claim_text(span5_nodes, "Sign up for our newsletter to get\n              ");
      span4 = claim_element(span5_nodes, "SPAN", {
        class: true
      });
      var span4_nodes = children(span4);
      t19 = claim_text(span4_nodes, "two free chapter previews");
      span4_nodes.forEach(detach_dev);
      t20 = claim_text(span5_nodes, "\n              on building color palettes and designing without labels.");
      ...
      t23 = claim_text(button_nodes, "Get the previews");
      ...
      t25 = claim_text(p1_nodes, "Something went wrong, please try again.");
      ...
      t27 = claim_text(p2_nodes, "Or\n              ");
      a = claim_element(p2_nodes, "A", {
        href: true
      });
      var a_nodes = children(a);
      t28 = claim_text(a_nodes, "buy now");
      ...
      img1 = claim_element(div10_nodes, "IMG", {
        src: true,
        alt: true
      });
    ...
    h: function hydrate() {
      ...
      add_location(span0, file, 13, 8, 585);
      attr_dev(span1, "class", "md:block text-indigo-700");
      add_location(span1, file, 14, 8, 653);
      ...
      add_location(h10, file, 10, 6, 438);
      attr_dev(div2, "class", "hidden lg:block tracking-wide uppercase text-indigo-faded\n              font-bold text-lg xl:text-xl mb-4 opacity-75");
      add_location(div2, file, 23, 12, 943);
      attr_dev(span2, "class", "sm:block");
      add_location(span2, file, 32, 14, 1353);
      attr_dev(span3, "class", "sm:block text-indigo-700");
      add_location(span3, file, 33, 14, 1427);
      ...
      add_location(h11, file, 28, 12, 1147);
      attr_dev(p0, "class", "text-xl text-center md:text-left md:text-lg lg:text-xl\n              xl:text-2xl text-grey-700 leading-normal");
      add_location(p0, file, 37, 12, 1566);
      attr_dev(div3, "class", "mb-12");
      add_location(div3, file, 22, 10, 911);
      if (img0.src !== (img0_src_value = "https://refactoring-ui.nyc3.cdn.digitaloceanspaces.com/landing/book-cover-sm.png")) attr_dev(img0, "src", img0_src_value);
      attr_dev(img0, "alt", "");
      add_location(img0, file, 45, 12, 1950);
      attr_dev(div4, "class", "md:hidden px-8 pt-2 pb-4");
      add_location(div4, file, 44, 10, 1899);
      attr_dev(input0, "type", "hidden");
      attr_dev(input0, "name", "id");
      input0.value = "439908";
      attr_dev(input0, "id", "landing_page_id");
      add_location(input0, file, 55, 12, 2310);
      attr_dev(input1, "type", "hidden");
      attr_dev(input1, "name", "ck_form_recaptcha");
      input1.value = "";
      attr_dev(input1, "id", "ck_form_recaptcha");
      add_location(input1, file, 60, 12, 2448);
      attr_dev(span4, "class", "text-black font-bold");
      add_location(span4, file, 69, 14, 2802);
      attr_dev(span5, "class", "block text-grey-700 leading-normal text-center md:text-left\n              text-base xl:text-lg font-semibold mb-6");
      add_location(span5, file, 65, 12, 2597);
      attr_dev(input2, "type", "email");
      attr_dev(input2, "id", "ck_emailField");
      attr_dev(input2, "name", "email");
      input2.required = "";
      attr_dev(input2, "placeholder", "Enter your email");
      attr_dev(input2, "class", "shadow sm:shadow-none block w-full rounded-lg\n                  focus:border-indigo border border-transparent\n                  sm:rounded-r-none mb-4 sm:mb-0 text-black sm:flex-1 px-6 py-4\n                  lg:py-5 focus:outline-none");
      add_location(input2, file, 79, 16, 3198);
      attr_dev(button, "id", "ck_subscribe_button");
      attr_dev(button, "class", "text-sm shadow sm:shadow-none block w-full sm:w-auto\n                  rounded-lg sm:rounded-none focus:outline-none bg-indigo-500\n                  hover:bg-indigo-700 focus:bg-indigo-700 text-white text-shadow\n                  uppercase tracking-wide font-semibold px-6 py-4 lg:py-5");
      add_location(button, file, 89, 16, 3663);
      attr_dev(div5, "class", "max-w-sm sm:flex sm:shadow sm:rounded-lg\n                sm:overflow-hidden");
      add_location(div5, file, 76, 14, 3076);
      attr_dev(div6, "class", "sm:focus-within:shadow-outline rounded-lg");
      add_location(div6, file, 75, 12, 3006);
      add_location(p1, file, 105, 14, 4352);
      attr_dev(div7, "id", "ck_error_msg");
      attr_dev(div7, "class", "sm:absolute pin-x text-center md:text-left text-indigo-700\n              font-semibold mt-6 text-lg");
      set_style(div7, "display", "none");
      add_location(div7, file, 100, 12, 4141);
      attr_dev(form, "class", "relative max-w-sm");
      attr_dev(form, "id", "ck_subscribe_form");
      attr_dev(form, "action", "https://app.convertkit.com/landing_pages/439908/subscribe");
      attr_dev(form, "data-remote", "true");
      add_location(form, file, 50, 10, 2108);
      attr_dev(a, "href", "#get-refactoring-ui");
      add_location(a, file, 111, 14, 4554);
      add_location(p2, file, 109, 12, 4519);
      attr_dev(div8, "class", "markdown text-lg mt-6 text-center md:text-left");
      add_location(div8, file, 108, 10, 4446);
      attr_dev(div9, "class", "md:w-3/5 px-8");
      add_location(div9, file, 21, 8, 873);
      if (img1.src !== (img1_src_value = "https://refactoring-ui.nyc3.cdn.digitaloceanspaces.com/landing/book-cover-sm.png")) attr_dev(img1, "src", img1_src_value);
      attr_dev(img1, "alt", "");
      add_location(img1, file, 117, 10, 4764);
      attr_dev(div10, "class", "hidden md:block md:w-2/5 px-8 pt-2 lg:pt-16");
      add_location(div10, file, 116, 8, 4696);
      attr_dev(div11, "class", "relative flex flex-wrap flex-col md:flex-row lg:items-center\n        -mx-8");
      add_location(div11, file, 18, 6, 768);
      attr_dev(div12, "class", "relative container mx-auto px-8");
      add_location(div12, file, 4, 4, 204);
      attr_dev(div13, "class", "py-16 bg-gray-300 overflow-x-hidden");
      add_location(div13, file, 3, 2, 150);
...
function create_fragment$3(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(a1, "href", "/book/table-of-contents/");
      add_location(a1, file$3, 110, 6, 4626);
      add_location(p7, file$3, 109, 4, 4616);
      add_location(p8, file$3, 115, 4, 4732);
      attr_dev(a2, "href", "https://medium.com/refactoring-ui/7-practical-tips-for-cheating-at-design-40c736799886");
      add_location(a2, file$3, 125, 6, 5153);
      add_location(p9, file$3, 122, 4, 5007);
      add_location(h21, file$3, 132, 4, 5347);
      add_location(p10, file$3, 134, 4, 5377);
      ...
      attr_dev(img1, "alt", "");
      add_location(img1, file$3, 140, 6, 5542);
      attr_dev(div2, "class", "px-6");
      add_location(div2, file$3, 139, 4, 5517);
      add_location(p11, file$3, 145, 4, 5692);
      add_location(strong2, file$3, 153, 8, 5913);
      add_location(li0, file$3, 152, 6, 5900);
      add_location(strong3, file$3, 156, 8, 5996);
      add_location(li1, file$3, 155, 6, 5983);
      add_location(strong4, file$3, 159, 8, 6078);
      add_location(li2, file$3, 158, 6, 6065);
      add_location(ol, file$3, 151, 4, 5889);
      add_location(p12, file$3, 163, 4, 6158);
      add_location(h22, file$3, 168, 4, 6322);
      add_location(p13, file$3, 170, 4, 6358);
      add_location(strong5, file$3, 179, 6, 6717);
      add_location(strong6, file$3, 181, 6, 6784);
      add_location(p14, file$3, 177, 4, 6657);
      ...
      attr_dev(img2, "alt", "");
      add_location(img2, file$3, 186, 6, 6881);
      attr_dev(div3, "class", "px-6");
      add_location(div3, file$3, 185, 4, 6856);
      add_location(p15, file$3, 191, 4, 7032);
      add_location(li3, file$3, 197, 6, 7204);
      add_location(li4, file$3, 198, 6, 7233);
      add_location(li5, file$3, 199, 6, 7267);
      add_location(li6, file$3, 200, 6, 7306);
      add_location(li7, file$3, 201, 6, 7334);
      add_location(li8, file$3, 202, 6, 7362);
      add_location(ul, file$3, 196, 4, 7193);
      add_location(p16, file$3, 205, 4, 7405);
      add_location(p17, file$3, 207, 4, 7439);
      add_location(h23, file$3, 211, 4, 7534);
      add_location(p18, file$3, 213, 4, 7563);
      add_location(strong7, file$3, 221, 6, 7814);
      add_location(p19, file$3, 219, 4, 7757);
      ...
      attr_dev(img3, "alt", "");
      add_location(img3, file$3, 227, 6, 8047);
      attr_dev(div4, "class", "px-6");
      add_location(div4, file$3, 226, 4, 8022);
      add_location(p20, file$3, 232, 4, 8197);
      add_location(h24, file$3, 238, 4, 8394);
      add_location(p21, file$3, 240, 4, 8429);
      add_location(p22, file$3, 246, 4, 8681);
      ...
      attr_dev(img4, "alt", "");
      add_location(img4, file$3, 252, 6, 8876);
      attr_dev(div5, "class", "px-6");
      add_location(div5, file$3, 251, 4, 8851);
      add_location(p23, file$3, 257, 4, 9025);
      add_location(p24, file$3, 263, 4, 9243);
      add_location(h25, file$3, 268, 4, 9370);
      add_location(p25, file$3, 270, 4, 9409);
      ...
      attr_dev(img5, "alt", "");
      add_location(img5, file$3, 276, 6, 9547);
      attr_dev(div6, "class", "px-16 mb-8");
      add_location(div6, file$3, 275, 4, 9516);
      add_location(p26, file$3, 281, 4, 9696);
...
function create_fragment$7(ctx) {
  ...
  var pullquote0 = new PullQuote({
    $$inline: true
  });
  var whatsinside = new WhatsInside({
    $$inline: true
  });
  var pullquote1 = new PullQuote({
    $$inline: true
  });
  var buynow = new BuyNow({
    $$inline: true
  });
  var pullquote2 = new PullQuote2({
    $$inline: true
  });
  var faq = new FAQ({
    $$inline: true
  ...
  var block = {
    c: function create() {
      ...
      t2 = space();
      create_component(pullquote0.$$.fragment);
      t3 = space();
      create_component(whatsinside.$$.fragment);
      t4 = space();
      create_component(pullquote1.$$.fragment);
      t5 = space();
      create_component(buynow.$$.fragment);
      t6 = space();
      create_component(pullquote2.$$.fragment);
      t7 = space();
    ...
    l: function claim(nodes) {
      ...
      claim_component(why.$$.fragment, nodes);
      t2 = claim_space(nodes);
      claim_component(pullquote0.$$.fragment, nodes);
      t3 = claim_space(nodes);
      claim_component(whatsinside.$$.fragment, nodes);
      t4 = claim_space(nodes);
      claim_component(pullquote1.$$.fragment, nodes);
      t5 = claim_space(nodes);
      claim_component(buynow.$$.fragment, nodes);
      t6 = claim_space(nodes);
      claim_component(pullquote2.$$.fragment, nodes);
    ...
    m: function mount(target, anchor) {
      ...
      mount_component(why, target, anchor);
      insert_dev(target, t2, anchor);
      mount_component(pullquote0, target, anchor);
      insert_dev(target, t3, anchor);
      mount_component(whatsinside, target, anchor);
      insert_dev(target, t4, anchor);
      mount_component(pullquote1, target, anchor);
      insert_dev(target, t5, anchor);
      mount_component(buynow, target, anchor);
      insert_dev(target, t6, anchor);
      mount_component(pullquote2, target, anchor);
    ...
    i: function intro(local) {
      ...
      transition_in(pullquote0.$$.fragment, local);
      transition_in(whatsinside.$$.fragment, local);
      transition_in(pullquote1.$$.fragment, local);
      transition_in(buynow.$$.fragment, local);
      transition_in(pullquote2.$$.fragment, local);
    ...
    o: function outro(local) {
      ...
      transition_out(pullquote0.$$.fragment, local);
      transition_out(whatsinside.$$.fragment, local);
      transition_out(pullquote1.$$.fragment, local);
      transition_out(buynow.$$.fragment, local);
      transition_out(pullquote2.$$.fragment, local);
    ...
    d: function destroy(detaching) {
      ...
      destroy_component(why, detaching);
      if (detaching) detach_dev(t2);
      destroy_component(pullquote0, detaching);
      if (detaching) detach_dev(t3);
      destroy_component(whatsinside, detaching);
      if (detaching) detach_dev(t4);
      destroy_component(pullquote1, detaching);
      if (detaching) detach_dev(t5);
      destroy_component(buynow, detaching);
      if (detaching) detach_dev(t6);
      destroy_component(pullquote2, detaching);
