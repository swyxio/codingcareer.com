<div>
  <div role="presentation" class="h-8 bg-top bg-repeat bg-indigo-200" />
  <!-- style="background-image: url('/img/pattern-purple.svg')"  -->
  <div class="py-16 bg-gray-300 overflow-x-hidden">
