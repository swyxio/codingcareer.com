<h2
  class=" mt-16 capitalize text-4xl leading-10 font-display font-semibold
  text-gray-900 md:text-5xl md:leading-none text-center">
  About the author
</h2>
<div
  ...
  <div>
    ...
    <p class="ml-5 leading-6 mb-5">
      ...
      speaking
            ...
            class=" text-blue-500">
      teaching
    </a> and <a href="https://twitter.com/swyx">Twitter</a>
